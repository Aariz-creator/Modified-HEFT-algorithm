...
static double computeRank(Task task, Map<Integer, Map<Integer, Edge>> graph, Set<Integer> visited) {
 ...
 maxSuccRank = Math.max(maxSuccRank, ALPHA * (e.communicationCost + succRank));
 }
